...
public class Flag extends Entity{
    ...
    public Flag(GamePanel gp, TeamEnum team, int worldX, int worldY) {
        super(gp);
        maxLife = 2;
        life = maxLife;
    ...
    public void getImages() {
        try {
            ...
            BufferedImage tileSheet = ImageIO.read(getClass().getResourceAsStream("/entity/object/flags_tilesheet.png"));
